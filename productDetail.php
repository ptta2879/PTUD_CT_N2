...
<div class="container">
    <div class="row m-5">
      ...
      <div class="col-5">
        <div class="row">
          <div class="col-12">
            <h1 class="h3 ">Thịt chó bạn êy</h1>
             <h5 class="card-title font-weight-normal">Thịt chó mới ra lò đê</h5>
            <p class="card-text text-danger font-weight-bold">67.000 VND</p>
           
            <p>Hãy đến với chúng tôi chúng tôi sẽ cho bạn những miếng thịt chó ngon hơn cả bò cobe ăn một lần nhớ cả đời</p>
        ...
        <div class="row">
          <div class="col-12 mb-3">
            <form class="form-inline">
              <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Chọn số lượng</label>
