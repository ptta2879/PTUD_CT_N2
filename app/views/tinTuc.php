        ...
        <div class="col-12 col-md-6 col-lg-8">
          ...
          <article class="mb-3">
            ...
            <figure class="figure">
              ...
              <figcaption class="figure-caption small">
                <p class="mb-0"><i class="fas fa-user-edit"></i><span class="sr-only">Photo by:</span>Tên Người Viết</p>
              </figcaption>
            </figure>
            ...
            <a href="baiViet.php" class="btn btn-secondary">Read more</a>
          </article>
          <hr>
          ...
          <article class="mb-3">
            ...
            <figure class="figure">
              <img src="http://placehold.it/800x600" class="figure-img img-fluid" alt="Figure image">
              <figcaption class="figure-caption small">
                <p class="mb-0"><i class="fas fa-user-edit"></i><span class="sr-only">Photo by:</span> Artist Name</p>
              </figcaption>
            </figure>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sed arcu bibendum massa euismod scelerisque. Morbi porttitor tellus tempor metus posuere dictum. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
            <a href="baiViet.php" class="btn btn-secondary">Read more</a>
          ...
          <aside>
            ...
            <div class="list-group mb-3">
              <a href="#0" class="list-group-item list-group-item-action">
                ...
                <p class="small mb-2">Tên Người Viết (<time>Saturday, June, 2020 at 11:39 PM</time>)</p>
